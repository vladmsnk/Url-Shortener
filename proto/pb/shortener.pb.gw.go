...
func RegisterUrlShortenerHandlerServer(ctx context.Context, mux *runtime.ServeMux, server UrlShortenerServer) error {
	...
	mux.Handle("GET", pattern_UrlShortener_GetURL_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/proto_url.UrlShortener/GetURL", runtime.WithHTTPPathPattern("/{shortURL}"))
		if err != nil {
...
func RegisterUrlShortenerHandlerClient(ctx context.Context, mux *runtime.ServeMux, client UrlShortenerClient) error {
	...
	mux.Handle("GET", pattern_UrlShortener_GetURL_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/proto_url.UrlShortener/GetURL", runtime.WithHTTPPathPattern("/{shortURL}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
var (
	pattern_UrlShortener_GetURL_0 = runtime.MustPattern(runtime.NewPattern(1, []int{1, 0, 4, 1, 5, 0}, []string{"shortURL"}, ""))
)
